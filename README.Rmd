...
example_table <- gt::gt(head(mtcars[c("mpg", "cyl", "hp", "wt")], 5)) |>
  gt::tab_header(title = "Vehicle characteristics", subtitle = "Selected models from mtcars") |>
  gt_theme_ekio()
dir.create("man/figures", recursive = TRUE, showWarnings = FALSE)
invisible(capture.output(
  gt::gtsave(example_table, "man/figures/README-example-table.png", vwidth = 800)
))
