...
gt_theme_ekio_alt <- function(
  ...
  colors <- list(
    editorial = .ekio("ekio_brand", "Baltic Blue"), # title, row groups
    structure = .ekio("blue", 700), # column labels, summary text
    structure_dark = .ekio("blue", 800), # grand summary background
    structure_light = .ekio("blue", 100), # summary row tint
    text = .ekio("gray", 900),
