...
vignette: >
  %\VignetteIndexEntry{Table theme gallery}
...
headings with blue rules, and a dark grand total. The table sits on the warm
offwhite surface `ekioplot::theme_ekio()` draws on, so a chart and a table in
one document share a background. Pass `background = "white"`, `"cold"`, or
`"transparent"` to change it. It does not add a footer.
